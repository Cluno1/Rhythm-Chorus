...
android {
    ...
    defaultConfig {
        ...
        versionCode = overrideVersionCode ?: 524231109
        versionName = overrideVersionName ?: "5.2.423.1109"

        val overrideReleaseDate = project.findProperty("releaseDateOverride")?.toString()
        buildConfigField("String", "RELEASE_DATE", "\"${overrideReleaseDate ?: "2026-07-05"}\"")
