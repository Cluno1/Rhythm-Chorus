...
android {
    ...
    defaultConfig {
        ...
        versionCode = overrideVersionCode ?: 534311134
        versionName = overrideVersionName ?: "5.3.431.1134 Beta"

        val overrideReleaseDate = project.findProperty("releaseDateOverride")?.toString()
        buildConfigField("String", "RELEASE_DATE", "\"${overrideReleaseDate ?: "2026-07-16"}\"")
