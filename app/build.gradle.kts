...
android {
    ...
    defaultConfig {
        ...
        versionCode = overrideVersionCode ?: 554731243
        versionName = overrideVersionName ?: "5.5.473.1243 Beta"

        val overrideReleaseDate = project.findProperty("releaseDateOverride")?.toString()
        buildConfigField("String", "RELEASE_DATE", "\"${overrideReleaseDate ?: "2026-09-01"}\"")
