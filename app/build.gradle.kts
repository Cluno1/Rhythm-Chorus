...
android {
    ...
    defaultConfig {
        ...
        versionCode = overrideVersionCode ?: 534291123
        versionName = overrideVersionName ?: "5.3.429.1123 Beta"

        val overrideReleaseDate = project.findProperty("releaseDateOverride")?.toString()
        buildConfigField("String", "RELEASE_DATE", "\"${overrideReleaseDate ?: "2026-07-12"}\"")
