...
android {
    ...
    defaultConfig {
        ...
        versionCode = overrideVersionCode ?: 534261114
        versionName = overrideVersionName ?: "5.3.426.1114 Beta"

        val overrideReleaseDate = project.findProperty("releaseDateOverride")?.toString()
        buildConfigField("String", "RELEASE_DATE", "\"${overrideReleaseDate ?: "2026-07-08"}\"")
