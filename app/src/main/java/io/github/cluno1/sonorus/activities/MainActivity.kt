...
import io.github.cluno1.sonorus.shared.presentation.navigation.RhythmNavigation
import io.github.cluno1.sonorus.ui.theme.RhythmTheme
import io.github.cluno1.sonorus.ui.theme.festive.FestiveOverlayFromSettings
import io.github.cluno1.sonorus.shared.presentation.viewmodel.ThemeViewModel
import io.github.cluno1.sonorus.util.CrashReporter
...
import io.github.cluno1.sonorus.shared.presentation.components.icons.Icon as RhythmIcon
...
import io.github.cluno1.sonorus.shared.presentation.components.PermissionHandler
import io.github.cluno1.sonorus.shared.presentation.components.dialogs.BetaProgramPopup
import io.github.cluno1.sonorus.shared.presentation.components.dialogs.TrackCorruptionDialog
import io.github.cluno1.sonorus.features.local.presentation.screens.OnboardingScreen
...
class MainActivity : AppCompatActivity() {
                        ...
                        if (!hasHandledStartupIntents) {
                            ...
                            val shouldHandleStartupIntent = startupIntent?.let {
                                (it.action == Intent.ACTION_VIEW && it.data != null) ||
                                    it.action == "io.github.cluno1.sonorus.action.SHORTCUT_PLAY_PAUSE" ||
                                    it.action == "io.github.cluno1.sonorus.action.SHORTCUT_SKIP_NEXT" ||
                                    it.action == "io.github.cluno1.sonorus.action.SHORTCUT_SKIP_PREVIOUS" ||
                                ...
                                Column(
                                    ...
                                    Row(
                                        ...
                                        Image(
                                            ...
                                            contentDescription = stringResource(R.string.cd_sonorus_logo),
    ...
    private fun handleIntent(intent: Intent?) {
        ...
        try {
            ...
            when (intent.action) {
                "io.github.cluno1.sonorus.action.SHORTCUT_PLAY_PAUSE" -> {
                    ShortcutManagerCompat.reportShortcutUsed(this, "shortcut_play_pause")
                    Log.d(TAG, "Received Play/Pause shortcut action")
                    val playPauseIntent = Intent(this, io.github.cluno1.sonorus.infrastructure.service.MediaPlaybackService::class.java).apply {
                        action = io.github.cluno1.sonorus.infrastructure.service.MediaPlaybackService.ACTION_PLAY_PAUSE
                    }
                    try {
                ...
                "io.github.cluno1.sonorus.action.SHORTCUT_SKIP_NEXT" -> {
                    ShortcutManagerCompat.reportShortcutUsed(this, "shortcut_next")
                    Log.d(TAG, "Received Skip Next shortcut action")
                    val nextIntent = Intent(this, io.github.cluno1.sonorus.infrastructure.service.MediaPlaybackService::class.java).apply {
                        action = io.github.cluno1.sonorus.infrastructure.service.MediaPlaybackService.ACTION_SKIP_NEXT
                    }
                    try {
                ...
                "io.github.cluno1.sonorus.action.SHORTCUT_SKIP_PREVIOUS" -> {
                    ShortcutManagerCompat.reportShortcutUsed(this, "shortcut_previous")
                    Log.d(TAG, "Received Skip Previous shortcut action")
                    val prevIntent = Intent(this, io.github.cluno1.sonorus.infrastructure.service.MediaPlaybackService::class.java).apply {
                        action = io.github.cluno1.sonorus.infrastructure.service.MediaPlaybackService.ACTION_SKIP_PREVIOUS
                    }
                    try {
    ...
    private suspend fun startMediaServiceAndWait(): Boolean {
        return try {
            val serviceIntent = Intent(this, io.github.cluno1.sonorus.infrastructure.service.MediaPlaybackService::class.java)
            serviceIntent.action = io.github.cluno1.sonorus.infrastructure.service.MediaPlaybackService.ACTION_INIT_SERVICE
    ...
    private suspend fun fallbackPlayExternalFile(uri: Uri) {
        try {
            ...
            val playIntent = Intent(applicationContext, io.github.cluno1.sonorus.infrastructure.service.MediaPlaybackService::class.java)
            playIntent.action = io.github.cluno1.sonorus.infrastructure.service.MediaPlaybackService.ACTION_PLAY_EXTERNAL_FILE
            playIntent.data = uri
    ...
    override fun onDestroy() {
        ...
        kotlinx.coroutines.CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                io.github.cluno1.sonorus.util.CacheManager.autoTrimCache(applicationContext, maxSize)
            } catch (e: Exception) {
    ...
    private fun getStepName(step: OnboardingStep): String {
        return when (step) {
            ...
            OnboardingStep.RHYTHM_GUARD -> "Sonorus Guard"
            ...
            OnboardingStep.RHYTHM_STATS -> "Sonorus Stats"
