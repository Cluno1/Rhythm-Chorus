...
fun SongEntity.toSong(): io.github.cluno1.sonorus.shared.data.model.Song {
    ...
    return io.github.cluno1.sonorus.shared.data.model.Song(
        id = id,
        title = title,
        artist = artist,
        album = album,
...
fun io.github.cluno1.sonorus.shared.data.model.Song.toEntity(): SongEntity {
    val normalizedDateAdded = if (dateAdded in 1..99_999_999_999L) dateAdded * 1000L else dateAdded
    val normalizedDateModified = if (dateModified in 1..99_999_999_999L) dateModified * 1000L else dateModified
    return SongEntity(
        id = id,
