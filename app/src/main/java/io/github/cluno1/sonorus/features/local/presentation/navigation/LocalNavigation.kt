...
import io.github.cluno1.sonorus.ui.theme.MusicDimensions
...
import io.github.cluno1.sonorus.shared.presentation.components.bottomsheets.SongPickerBottomSheet
import io.github.cluno1.sonorus.shared.presentation.components.common.CollapsibleHeaderScreen
import io.github.cluno1.sonorus.shared.presentation.components.common.ExpressiveFilledIconButton
...
import io.github.cluno1.sonorus.ui.UiConstants
...
import io.github.cluno1.sonorus.features.local.presentation.screens.AddToPlaylistScreen
...
import io.github.cluno1.sonorus.shared.presentation.screens.UniversalSearchCatalogSource
import io.github.cluno1.sonorus.features.local.presentation.screens.EqualizerScreen
import io.github.cluno1.sonorus.shared.presentation.screens.player.PlayerScreen

import io.github.cluno1.sonorus.features.local.presentation.screens.PlaylistDetailScreen
import io.github.cluno1.sonorus.features.local.presentation.screens.ArtistDetailScreen
import io.github.cluno1.sonorus.features.local.presentation.screens.AlbumDetailScreen
import io.github.cluno1.sonorus.shared.presentation.screens.settings.SettingsScreenWrapper
import io.github.cluno1.sonorus.shared.presentation.screens.settings.*
import io.github.cluno1.sonorus.features.streaming.presentation.screens.StreamingServiceSetupScreen
import io.github.cluno1.sonorus.features.streaming.presentation.screens.GoSettingsScreen
import io.github.cluno1.sonorus.features.streaming.presentation.screens.toLibraryAlbum
import io.github.cluno1.sonorus.features.streaming.presentation.screens.toLibraryArtist
import io.github.cluno1.sonorus.features.streaming.presentation.screens.toLibraryPlaylist
import io.github.cluno1.sonorus.features.streaming.presentation.screens.toLibrarySong
import io.github.cluno1.sonorus.features.streaming.presentation.model.StreamingServiceOptions
import io.github.cluno1.sonorus.features.streaming.presentation.viewmodel.StreamingMusicViewModel
...
import io.github.cluno1.sonorus.shared.presentation.components.MediaScanLoader // Add MediaScanLoader import
import io.github.cluno1.sonorus.util.ArtistSeparator
...
import io.github.cluno1.sonorus.features.local.presentation.viewmodel.MusicViewModel.SortOrder
import io.github.cluno1.sonorus.shared.presentation.viewmodel.ThemeViewModel
...
fun LocalNavigation(
    ...
    appSettings: io.github.cluno1.sonorus.shared.data.model.AppSettings // Add appSettings parameter
) {
    ...
    val onPlaySong = { song: io.github.cluno1.sonorus.shared.data.model.Song -> viewModel.playSong(song) }
    val onPlayAlbum = { album: io.github.cluno1.sonorus.shared.data.model.Album -> viewModel.playAlbum(album) }
    val onPlayAlbumShuffled = { album: io.github.cluno1.sonorus.shared.data.model.Album -> viewModel.playAlbumShuffled(album) }
    val onPlayArtist = { artist: io.github.cluno1.sonorus.shared.data.model.Artist -> viewModel.playArtist(artist) }
    val onPlayPlaylist =
        { playlist: io.github.cluno1.sonorus.shared.data.model.Playlist -> viewModel.playPlaylist(playlist) }
    val onPlayPlaylistShuffled = { playlist: io.github.cluno1.sonorus.shared.data.model.Playlist -> viewModel.playPlaylistShuffled(playlist) }
...
private fun LocalNavigationContent(
    ...
    themeViewModel: ThemeViewModel,
    appSettings: io.github.cluno1.sonorus.shared.data.model.AppSettings,
    snackbarHostState: SnackbarHostState,
    coroutineScope: kotlinx.coroutines.CoroutineScope,
    currentSong: io.github.cluno1.sonorus.shared.data.model.Song?,
    currentRoute: String,
    isPlaying: Boolean,
    progress: () -> Float,
    onPlayPause: () -> Unit,
    ...
    songs: List<io.github.cluno1.sonorus.shared.data.model.Song>,
    allSongs: List<io.github.cluno1.sonorus.shared.data.model.Song>,
    albums: List<io.github.cluno1.sonorus.shared.data.model.Album>,
    artists: List<io.github.cluno1.sonorus.shared.data.model.Artist>,
    playlists: List<io.github.cluno1.sonorus.shared.data.model.Playlist>,
    ...
    lyrics: io.github.cluno1.sonorus.shared.data.model.LyricsData?,
    isLoadingLyrics: Boolean,
    recentlyPlayed: List<io.github.cluno1.sonorus.shared.data.model.Song>,
    ...
    onPlaySong: (io.github.cluno1.sonorus.shared.data.model.Song) -> Unit,
    onPlayAlbum: (io.github.cluno1.sonorus.shared.data.model.Album) -> Unit,
    onPlayAlbumShuffled: (io.github.cluno1.sonorus.shared.data.model.Album) -> Unit,
    onPlayArtist: (io.github.cluno1.sonorus.shared.data.model.Artist) -> Unit,
    onPlayPlaylist: (io.github.cluno1.sonorus.shared.data.model.Playlist) -> Unit,
    onPlayPlaylistShuffled: (io.github.cluno1.sonorus.shared.data.model.Playlist) -> Unit,
    ...
    LaunchedEffect(activeCatalogItem?.renditionId, catalogState.songs) {
        ...
        viewModel.refreshCatalogNowPlayingMetadata(
            RhythmNowPlayingItem(
                ...
                renditionRevision = refreshed.renditionRevision,
                ...
                lyricsFormats = refreshed.lyricsFormats,
        ...
        catalogSongByDisplayId[displaySong.id.toStableCatalogSongId()]?.let { song ->
            RhythmQueueEntry(
                nowPlaying = RhythmNowPlayingItem(
                    ...
                    renditionRevision = song.renditionRevision,
                    assetId = null,
                    title = song.title,
                    ...
                    lyricsFormats = song.lyricsFormats,
    ...
    val playStreamingMappedQueue: (List<io.github.cluno1.sonorus.shared.data.model.Song>, Int, Boolean) -> Unit =
    ...
    val songForCreatePlaylistDialog = remember { mutableStateOf<io.github.cluno1.sonorus.shared.data.model.Song?>(null) }
        ...
        Box(modifier = Modifier.fillMaxSize()) {
            ...
            NavHost(
                ...
                composable(
                    ...
                    val streamingViewModel: io.github.cluno1.sonorus.features.streaming.presentation.viewmodel.StreamingMusicViewModel = androidx.lifecycle.viewmodel.compose.viewModel()

                    SlideUpCornerWrapper {
                        io.github.cluno1.sonorus.shared.presentation.screens.UniversalSearchScreen(
                ...
                composable(Screen.TunerAbout.route) {
                    io.github.cluno1.sonorus.shared.presentation.screens.settings.AboutScreen(
                ...
                composable(Screen.TunerGoSettings.route) {
                    io.github.cluno1.sonorus.features.streaming.presentation.screens.GoSettingsScreen(
                        onBackClick = navigateBackOrToSettings,
                ...
                composable(
                    ...
                    var selectedSongForInfo by remember { mutableStateOf<io.github.cluno1.sonorus.shared.data.model.Song?>(null) }
                ...
                composable(
                    ...
                    var selectedSongForPlaylist by remember { mutableStateOf<io.github.cluno1.sonorus.shared.data.model.Song?>(null) }
                    var showCreatePlaylistDialog by remember { mutableStateOf(false) }
                    var songForCreatePlaylistDialog by remember { mutableStateOf<io.github.cluno1.sonorus.shared.data.model.Song?>(null) }
                    var showSongInfoSheet by remember { mutableStateOf(false) }
                    var selectedSongForInfo by remember { mutableStateOf<io.github.cluno1.sonorus.shared.data.model.Song?>(null) }
