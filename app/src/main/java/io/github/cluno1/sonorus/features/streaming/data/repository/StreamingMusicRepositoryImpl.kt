...
package io.github.cluno1.sonorus.features.streaming.data.repository
...
import io.github.cluno1.sonorus.features.streaming.data.provider.JellyfinApiClient
import io.github.cluno1.sonorus.features.streaming.data.provider.ProviderConnectionResult
import io.github.cluno1.sonorus.features.streaming.data.provider.ProviderAlbum
import io.github.cluno1.sonorus.features.streaming.data.provider.ProviderArtist
import io.github.cluno1.sonorus.features.streaming.data.provider.ProviderPlaylist
import io.github.cluno1.sonorus.features.streaming.data.provider.ProviderSong
...
class StreamingMusicRepositoryImpl(
    ...
    private fun mapProviderPlaylist(
        ...
        return StreamingPlaylist(
            ...
            owner = if (providerPlaylist.owner != null) {
                io.github.cluno1.sonorus.features.streaming.domain.model.PlaylistOwner(
    ...
    private fun mapProviderAlbum(serviceId: String, providerAlbum: ProviderAlbum): StreamingAlbum {
        return StreamingAlbum(
            ...
            releaseDate = null,
            albumType = io.github.cluno1.sonorus.features.streaming.domain.model.AlbumType.ALBUM,
            genres = emptyList(),
            label = null,
            copyright = null,
            isExplicit = false
