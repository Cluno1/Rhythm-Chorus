...
import io.github.cluno1.sonorus.core.domain.model.StreamingQuality
...
import io.github.cluno1.sonorus.features.streaming.presentation.model.StreamingServiceOption
...
fun GoSettingsScreen(
    ...
    pendingServiceSelection?.let { pendingId ->
        androidx.compose.material3.AlertDialog(
            ...
            title = {
                Text(
                    text = stringResource(id = io.github.cluno1.sonorus.R.string.streaming_settings_switch_provider_confirm_title),
            ...
            text = {
                ...
                Text(
                    text = stringResource(id = io.github.cluno1.sonorus.R.string.streaming_settings_switch_provider_confirm_desc, currentLabel, pendingLabel),
            ...
            confirmButton = {
                Button(onClick = {
                    ...
                    Text(text = stringResource(id = io.github.cluno1.sonorus.R.string.action_switch))
                }
            },
            dismissButton = {
                OutlinedButton(onClick = { pendingServiceSelection = null }) {
                    Text(text = stringResource(id = io.github.cluno1.sonorus.R.string.action_cancel))
                }
            }
        )
    }
...
private fun StreamingStatusCard(
    ...
    val badgeText = when {
        isLoading -> stringResource(id = io.github.cluno1.sonorus.R.string.streaming_status_badge_refreshing)
        isConnected -> stringResource(id = io.github.cluno1.sonorus.R.string.streaming_status_badge_connected)
        else -> stringResource(id = io.github.cluno1.sonorus.R.string.streaming_status_badge_pending)
    }
    ...
    Card(
        ...
        Column(
            ...
            if (isConnected) {
                ...
                Text(
                    text = stringResource(id = io.github.cluno1.sonorus.R.string.streaming_status_connect_hint),
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.onPrimaryContainer.copy(alpha = 0.9f)
                )
            }
...
private fun ServiceSelectionBottomSheet(
    ...
    sessions: Map<String, io.github.cluno1.sonorus.features.streaming.data.repository.StreamingServiceSession>,
    onDismiss: () -> Unit,
...
private fun selectedServiceLabel(selectedService: String, context: Context): String {
    ...
    return matching?.let { context.getString(it.nameRes) } ?: context.getString(io.github.cluno1.sonorus.R.string.streaming_not_selected)
}
