...
package io.github.cluno1.sonorus.infrastructure.service
...
import io.github.cluno1.sonorus.shared.data.model.TransitionSettings
import io.github.cluno1.sonorus.shared.data.model.TransitionMode
...
import io.github.cluno1.sonorus.infrastructure.service.player.RhythmPlayerEngine
import io.github.cluno1.sonorus.infrastructure.service.player.TransitionController
import io.github.cluno1.sonorus.infrastructure.service.player.PreloadController
...
class MediaPlaybackService : MediaLibraryService(), Player.Listener {
    ...
    private var rhythmBassBoostProcessor: io.github.cluno1.sonorus.infrastructure.audio.RhythmBassBoostProcessor? = null
    private var rhythmSpatializationProcessor: io.github.cluno1.sonorus.infrastructure.audio.RhythmSpatializationProcessor? = null
    private var rhythmMonoAudioProcessor: io.github.cluno1.sonorus.infrastructure.audio.RhythmMonoAudioProcessor? = null
    ...
    private var btInfo: io.github.cluno1.sonorus.util.BtCodecInfo? = null
    private var btProxy: io.github.cluno1.sonorus.util.BtCodecInfo.Companion.Proxy? = null
    ...
    private fun clearLyricsState() {
        ...
        currentLyricIndex = -1
        io.github.cluno1.sonorus.infrastructure.widget.glance.GlanceWidgetUpdater.updateLyrics(this, emptyList(), -1)
    }
    ...
    private val btReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            if (intent?.action == "android.bluetooth.a2dp.profile.action.CODEC_CONFIG_CHANGED" &&
                ...
                val newBtInfo = io.github.cluno1.sonorus.util.BtCodecInfo.fromCodecConfig(codecStatus?.codecConfig)
    ...
    private fun showCodecNotification(info: io.github.cluno1.sonorus.util.BtCodecInfo) {
    ...
    private fun showRhythmGuardAlertNotification(title: String, text: String, riskLevel: String) {
        ...
        val notification = NotificationCompat.Builder(this, "rhythm_guard_alerts")
            .setSmallIcon(io.github.cluno1.sonorus.R.drawable.ic_notification)
        ...
        val notification = NotificationCompat.Builder(this, "rhythm_guard_timers")
            ...
            .setStyle(
                NotificationCompat.BigTextStyle().bigText(
                    "$text\n${getString(io.github.cluno1.sonorus.R.string.settings_rhythm_guard_notification_tap_open)}"
                )
            )
    ...
    private fun ensureRhythmGuardNotificationChannels(notificationManager: NotificationManager) {
        ...
        val alertChannel = NotificationChannel(
            "rhythm_guard_alerts",
            getString(io.github.cluno1.sonorus.R.string.service_rhythm_guard_alerts),
            NotificationManager.IMPORTANCE_HIGH
        ).apply {
            description = getString(io.github.cluno1.sonorus.R.string.service_rhythm_guard_alerts_desc)
            enableVibration(true)
        }

        val timerChannel = NotificationChannel(
            "rhythm_guard_timers",
            getString(io.github.cluno1.sonorus.R.string.service_rhythm_guard_timers),
            NotificationManager.IMPORTANCE_DEFAULT
        ).apply {
            description = getString(io.github.cluno1.sonorus.R.string.service_rhythm_guard_timers_desc)
    ...
    private lateinit var statusBroadcaster: io.github.cluno1.sonorus.utils.StatusBroadcaster
    ...
    companion object {
        ...
        const val ACTION_UPDATE_SETTINGS = "io.github.cluno1.sonorus.action.UPDATE_SETTINGS"
        
        // Intent action for playing external files
        const val ACTION_PLAY_EXTERNAL_FILE = "io.github.cluno1.sonorus.action.PLAY_EXTERNAL_FILE"
        
        // Intent action for initializing the service
        const val ACTION_INIT_SERVICE = "io.github.cluno1.sonorus.action.INIT_SERVICE"
        
        // Intent actions for sleep timer
        const val ACTION_START_SLEEP_TIMER = "io.github.cluno1.sonorus.action.START_SLEEP_TIMER"
        const val ACTION_STOP_SLEEP_TIMER = "io.github.cluno1.sonorus.action.STOP_SLEEP_TIMER"
        const val ACTION_EXTEND_SLEEP_TIMER = "io.github.cluno1.sonorus.action.EXTEND_SLEEP_TIMER"
        
        // Intent actions for equalizer
        const val ACTION_SET_EQUALIZER_ENABLED = "io.github.cluno1.sonorus.action.SET_EQUALIZER_ENABLED"
        const val ACTION_SET_EQUALIZER_BAND = "io.github.cluno1.sonorus.action.SET_EQUALIZER_BAND"
        const val ACTION_SET_BASS_BOOST = "io.github.cluno1.sonorus.action.SET_BASS_BOOST"
        const val ACTION_SET_VIRTUALIZER = "io.github.cluno1.sonorus.action.SET_VIRTUALIZER"
        const val ACTION_SET_MONO_AUDIO = "io.github.cluno1.sonorus.action.SET_MONO_AUDIO"
        const val ACTION_APPLY_EQUALIZER_PRESET = "io.github.cluno1.sonorus.action.APPLY_EQUALIZER_PRESET"
        const val ACTION_GET_EQUALIZER_DIAGNOSTICS = "io.github.cluno1.sonorus.action.GET_EQUALIZER_DIAGNOSTICS"
        
        // Widget control actions
        const val ACTION_PLAY_PAUSE = "io.github.cluno1.sonorus.action.PLAY_PAUSE"
        const val ACTION_PAUSE_FOR_IN_APP_AUDIO =
            "io.github.cluno1.sonorus.action.PAUSE_FOR_IN_APP_AUDIO"
        const val ACTION_SKIP_NEXT = "io.github.cluno1.sonorus.action.SKIP_NEXT"
        const val ACTION_SKIP_PREVIOUS = "io.github.cluno1.sonorus.action.SKIP_PREVIOUS"
        const val ACTION_TOGGLE_FAVORITE = "io.github.cluno1.sonorus.action.TOGGLE_FAVORITE"
        const val ACTION_TOGGLE_SHUFFLE = "io.github.cluno1.sonorus.action.TOGGLE_SHUFFLE"
        const val ACTION_TOGGLE_REPEAT = "io.github.cluno1.sonorus.action.TOGGLE_REPEAT"
        
        // Broadcast actions for status updates
        const val BROADCAST_SLEEP_TIMER_STATUS = "io.github.cluno1.sonorus.broadcast.SLEEP_TIMER_STATUS"
        ...
        const val ACTION_SHUFFLE_STATE_CHANGED = "io.github.cluno1.sonorus.action.SHUFFLE_STATE_CHANGED"
        const val EXTRA_SHUFFLE_ENABLED = "shuffle_enabled"
        
        // Audio session ID
        const val ACTION_GET_AUDIO_SESSION_ID = "io.github.cluno1.sonorus.action.GET_AUDIO_SESSION_ID"
        const val BROADCAST_AUDIO_SESSION_ID = "io.github.cluno1.sonorus.broadcast.AUDIO_SESSION_ID"
        const val EXTRA_AUDIO_SESSION_ID = "audio_session_id"
        
        // Mute/Unmute actions (Media3 1.9.0 feature)
        const val ACTION_MUTE = "io.github.cluno1.sonorus.action.MUTE"
        const val ACTION_UNMUTE = "io.github.cluno1.sonorus.action.UNMUTE"
        const val ACTION_TOGGLE_MUTE = "io.github.cluno1.sonorus.action.TOGGLE_MUTE"

        // Zero-volume pause/resume broadcasts — sent by service, received by UI to show/dismiss dialog
        const val ACTION_ZERO_VOLUME_PAUSE = "io.github.cluno1.sonorus.action.ZERO_VOLUME_PAUSE"
        const val ACTION_ZERO_VOLUME_RESUME = "io.github.cluno1.sonorus.action.ZERO_VOLUME_RESUME"
    ...
    override fun onCreate() {
        ...
        startForegroundWithNotification(
            getString(io.github.cluno1.sonorus.R.string.service_rhythm_music),
            getString(io.github.cluno1.sonorus.R.string.service_starting)
        )

        // Initialize settings manager (fast operation)
        updateForegroundNotification(
            getString(io.github.cluno1.sonorus.R.string.service_rhythm_music),
            getString(io.github.cluno1.sonorus.R.string.service_loading_settings)
        )
        ...
        try {
            rhythmBassBoostProcessor = io.github.cluno1.sonorus.infrastructure.audio.RhythmBassBoostProcessor().apply {
                setEnabled(appSettings.bassBoostEnabled.value)
                setStrength(appSettings.bassBoostStrength.value.toShort())
            }
            rhythmSpatializationProcessor = io.github.cluno1.sonorus.infrastructure.audio.RhythmSpatializationProcessor().apply {
                setEnabled(appSettings.virtualizerEnabled.value)
                setStrength(appSettings.virtualizerStrength.value.toShort())
            }
            rhythmMonoAudioProcessor = io.github.cluno1.sonorus.infrastructure.audio.RhythmMonoAudioProcessor().apply {
        ...
        statusBroadcaster = io.github.cluno1.sonorus.utils.StatusBroadcaster(applicationContext)

        // Register BroadcastReceiver for favorite changes
        updateForegroundNotification(
            getString(io.github.cluno1.sonorus.R.string.service_rhythm_music),
            getString(io.github.cluno1.sonorus.R.string.service_setup_components)
        )
        androidx.core.content.ContextCompat.registerReceiver(
            this,
            favoriteChangeReceiver,
            IntentFilter("io.github.cluno1.sonorus.action.FAVORITE_CHANGED"),
...
btProxy = io.github.cluno1.sonorus.util.BtCodecInfo.getCodec(this) { info ->
    if (info != null) {
        btInfo = info
        ...
        try {
            ...
            updateForegroundNotification(
                getString(io.github.cluno1.sonorus.R.string.service_rhythm_music),
                getString(io.github.cluno1.sonorus.R.string.service_initializing_player)
            )
            initializePlayer()

            updateForegroundNotification(
                getString(io.github.cluno1.sonorus.R.string.service_rhythm_music),
                getString(io.github.cluno1.sonorus.R.string.service_creating_controls)
            )
            ...
            updateForegroundNotification(
                getString(io.github.cluno1.sonorus.R.string.service_rhythm_music),
                getString(io.github.cluno1.sonorus.R.string.service_setup_media_session)
            )
            ...
            updateForegroundNotification(
                getString(io.github.cluno1.sonorus.R.string.service_rhythm_music),
                getString(io.github.cluno1.sonorus.R.string.service_initializing_controller)
            )
            createController()
                                ...
                                if (player.isPlaying) {
                                    ...
                                    if (currentMinutes > activeLimit) {
                                        ...
                                        val timeoutReason = getString(
                                            io.github.cluno1.sonorus.R.string.settings_rhythm_guard_timeout_reason_auto,
                                            formattedToday,
                                            formattedLimit
                                        )
                                        ...
                                        if (appSettings.rhythmGuardAlertNotificationsEnabled.value) {
                                            showRhythmGuardAlertNotification(
                                                title = getString(io.github.cluno1.sonorus.R.string.settings_rhythm_guard_notification_alert_title),
                                                text = timeoutReason,
                                                riskLevel = "HIGH"
                                            )
                                        }
                                        ...
                                        if (appSettings.rhythmGuardTimerNotificationsEnabled.value) {
                                            showRhythmGuardTimerNotification(
                                                title = getString(io.github.cluno1.sonorus.R.string.settings_rhythm_guard_notification_timer_active_title),
                                                text = getString(
                                                    io.github.cluno1.sonorus.R.string.settings_rhythm_guard_notification_timer_active_text,
            ...
            updateForegroundNotification(
                getString(io.github.cluno1.sonorus.R.string.service_rhythm_music),
                getString(io.github.cluno1.sonorus.R.string.service_ready)
            )
            ...
            updateForegroundNotification(
                getString(io.github.cluno1.sonorus.R.string.service_rhythm_music),
                getString(io.github.cluno1.sonorus.R.string.service_init_failed)
            )
        }
    }
...
val channel = NotificationChannel(
    CHANNEL_ID,
    getString(io.github.cluno1.sonorus.R.string.media3_notification_channel_name),
    NotificationManager.IMPORTANCE_LOW
).apply {
    description = getString(io.github.cluno1.sonorus.R.string.media3_notification_channel_description)
    setShowBadge(false)
}

val sleepTimerChannel = NotificationChannel(
    SLEEP_TIMER_CHANNEL_ID,
    getString(io.github.cluno1.sonorus.R.string.notification_sleep_timer_channel_name),
    NotificationManager.IMPORTANCE_DEFAULT
).apply {
    description = getString(io.github.cluno1.sonorus.R.string.notification_sleep_timer_channel_desc)
    setShowBadge(false)
    enableVibration(false)
}
...
notificationManager.createNotificationChannel(sleepTimerChannel)
    ...
    private fun startForegroundWithNotification(title: String = "Sonorus Music", content: String = "Sonorus is starting.") {
        ...
        serviceScope.launch {
            kotlinx.coroutines.flow.combine(
                ...
                if (currentLyricTexts.isNotEmpty()) {
                    io.github.cluno1.sonorus.infrastructure.widget.glance.GlanceWidgetUpdater.updateLyrics(
    ...
    private fun createCustomCommands() {
        customCommands = listOf(
            ...
            createCustomIconButton(
                "Add to favorites",
                FAVORITE_ON,
                io.github.cluno1.sonorus.R.drawable.ic_favorite_border
            ),
            createCustomIconButton(
                "Remove from favorites",
                FAVORITE_OFF,
                io.github.cluno1.sonorus.R.drawable.ic_favorite_filled
            )
        )
    }
        ...
        if (songId != null) {
            try {
                ...
                val song = if (currentMediaItem != null) {
                    ...
                    Song(
                        id = songId,
                        title = prefs.getString("song_title", "Sonorus") ?: "Sonorus",
                ...
                val notifyIntent = Intent("io.github.cluno1.sonorus.action.FAVORITE_CHANGED").apply {
        ...
        serviceScope.launch {
            try {
                ...
                val mediaItem = withContext(Dispatchers.IO) {
                    val resolvedMimeType = io.github.cluno1.sonorus.util.MediaUtils.getMediaMimeType(this@MediaPlaybackService, uri)
                    try {
                        val song = io.github.cluno1.sonorus.util.MediaUtils.extractMetadataFromUri(this@MediaPlaybackService, uri)
    ...
    private inner class MediaSessionCallback : MediaLibrarySession.Callback {
            ...
            return Futures.immediateFuture(
                when (customCommand.customAction) {
                    "UPDATE_LYRICS_DATA" -> {
                        ...
                        currentLyricIndex = -1
                        io.github.cluno1.sonorus.infrastructure.widget.glance.GlanceWidgetUpdater.updateLyrics(this@MediaPlaybackService, getProcessedLyricTexts(), -1)
                    ...
                    "UPDATE_ACTIVE_LYRIC" -> {
                        ...
                        // Update widgets
                        io.github.cluno1.sonorus.infrastructure.widget.glance.GlanceWidgetUpdater.updateLyrics(this@MediaPlaybackService, getProcessedLyricTexts(), lyricIndex)
        ...
        override fun onGetLibraryRoot(
            ...
            val rootItem = MediaItem.Builder()
                ...
                .setMediaMetadata(
                    MediaMetadata.Builder()
                        .setTitle("Sonorus Music Library")
    ...
    private fun updateSleepTimerProgressNotification(
        ...
        val title = getString(io.github.cluno1.sonorus.R.string.notification_sleep_timer_title)
        val timeText = formatSleepTimerDuration(remainingMs)
        val content = if (pauseOnly) {
            getString(io.github.cluno1.sonorus.R.string.notification_sleep_timer_pause_in, timeText)
        } else {
            getString(io.github.cluno1.sonorus.R.string.notification_sleep_timer_stop_in, timeText)
        }
        ...
        val appSettings = io.github.cluno1.sonorus.shared.data.model.AppSettings.getInstance(this)
    ...
    private fun initializeRhythmProcessors() {
        if (rhythmBassBoostProcessor == null) {
            ...
            try {
                rhythmBassBoostProcessor = io.github.cluno1.sonorus.infrastructure.audio.RhythmBassBoostProcessor()
                isBassBoostAvailable = true
                appSettings.setBassBoostAvailable(true)
            } catch (e: Exception) {
        ...
        if (rhythmSpatializationProcessor == null) {
            ...
            try {
                rhythmSpatializationProcessor = io.github.cluno1.sonorus.infrastructure.audio.RhythmSpatializationProcessor()
            } catch (e: Exception) {
        ...
        if (rhythmMonoAudioProcessor == null) {
            ...
            try {
                rhythmMonoAudioProcessor = io.github.cluno1.sonorus.infrastructure.audio.RhythmMonoAudioProcessor()
            } catch (e: Exception) {
    ...
    fun getEqualizerDiagnostics(): String {
        return buildString {
            ...
            appendLine("")
            appendLine("--- Sonorus Spatialization ---")
    ...
    fun getSpatializationStatus(): String {
        return when {
            ...
            !rhythmSpatializationProcessor!!.isEnabled() -> "Available (Sonorus)"
            else -> "Active (Sonorus)"
        }
    }
