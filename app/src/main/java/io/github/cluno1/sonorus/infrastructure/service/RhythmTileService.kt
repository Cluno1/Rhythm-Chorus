    ...
    override fun onClick() {
        ...
        if (hasActiveSong) {
            ...
            qsTile?.let { tile ->
                ...
                val nextIconRes = if (isPlaying) io.github.cluno1.sonorus.R.drawable.ic_play_shortcut else io.github.cluno1.sonorus.R.drawable.ic_pause_shortcut
    ...
    private fun updateTileState() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            ...
            if (hasActiveSong) {
                ...
                val iconRes = if (isPlaying) io.github.cluno1.sonorus.R.drawable.ic_pause_shortcut else io.github.cluno1.sonorus.R.drawable.ic_play_shortcut
                ...
                tile.icon = android.graphics.drawable.Icon.createWithResource(this, io.github.cluno1.sonorus.R.drawable.ic_notification)
            }
        } else {
            if (hasActiveSong) {
