...
class RhythmCookieWidget : GlanceAppWidget() {
    ...
    override suspend fun provideGlance(context: Context, id: GlanceId) {
        val appSettings = try {
            io.github.cluno1.sonorus.shared.data.model.AppSettings.getInstance(context)
        } catch (e: Exception) {
            null
        }
                ...
                if (cookieArtBitmap != null) {
                    ...
                    Box(
                        ...
                        Image(
                            ...
                            contentDescription = LocalContext.current.getString(R.string.rhythmcookiewidget_sonorus_logo),
    ...
    private fun getWidgetData(prefs: Preferences, appSettings: io.github.cluno1.sonorus.shared.data.model.AppSettings?): WidgetData {
        return try {
            WidgetData(
                songTitle = prefs[stringPreferencesKey(RhythmMusicWidget.KEY_SONG_TITLE)] ?: "Sonorus",
