...
object ExpressiveShapeProvider {
    ...
    fun getShapeById(shapeId: String, fallback: Shape = CircleShape): Shape {
        val roundedPolygon = io.github.cluno1.sonorus.shared.presentation.components.common.getShapeById(shapeId)
    ...
    fun isValidShapeId(shapeId: String): Boolean {
        return io.github.cluno1.sonorus.shared.presentation.components.common.getShapeById(shapeId) != null
    }
