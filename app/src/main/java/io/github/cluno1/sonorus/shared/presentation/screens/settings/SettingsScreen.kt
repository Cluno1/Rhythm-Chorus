...
import io.github.cluno1.sonorus.shared.presentation.navigation.RhythmGuardRiskLevel
import io.github.cluno1.sonorus.shared.presentation.navigation.rhythmGuardResolveRiskLevel
            ...
            Surface(
                ...
                AnimatedContent(
                    ...
                    when (route) {
                        ...
                        SettingsRoutes.ABOUT -> io.github.cluno1.sonorus.shared.presentation.screens.settings.AboutScreen(
...
fun SettingsTipsRow(
    ...
    LaunchedEffect(limitMinutes, manualVolumeFloat) {
        val statsRepo = io.github.cluno1.sonorus.shared.data.repository.PlaybackStatsRepository.getInstance(context)
        val audioManager = context.getSystemService(android.content.Context.AUDIO_SERVICE) as android.media.AudioManager
        
        while (true) {
            val stats = statsRepo.loadSummary(io.github.cluno1.sonorus.shared.data.repository.StatsTimeRange.TODAY)
            ...
            currentRiskLevel = io.github.cluno1.sonorus.shared.presentation.navigation.rhythmGuardResolveRiskLevel(
