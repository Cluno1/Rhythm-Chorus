...
package io.github.cluno1.sonorus.ui.theme
...
import io.github.cluno1.sonorus.util.ExtractedColors
...
fun getAlbumArtColorScheme(
    ...
    val extractedColors = io.github.cluno1.sonorus.util.ColorExtractor.jsonToColors(colorsJson)
    ...
    val isMonochrome = extractedColors.isMonochrome ||
        ...
        io.github.cluno1.sonorus.util.ColorExtractor.isArgbNearGrayscale(seedArgb)

    return if (isMonochrome) {
        io.github.cluno1.sonorus.util.ColorExtractor.createDynamicScheme(sourceHct, "MONOCHROME", darkTheme)
    } else if (useExactArtworkColors) {
        io.github.cluno1.sonorus.util.ColorExtractor.createDynamicScheme(sourceHct, "CONTENT", darkTheme)
    } else {
        val schemeType = when {
        ...
        io.github.cluno1.sonorus.util.ColorExtractor.createDynamicScheme(sourceHct, schemeType, darkTheme)
    }
}
