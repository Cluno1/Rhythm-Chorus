...
object LyricsParser {
    ...
    fun parseLyrics(lrcContent: String): List<LyricLine> {
        ...
        val trim = runCatching { AppSettings.getInstance(io.github.cluno1.sonorus.RhythmApplication.instance).trimLyrics.value }.getOrDefault(true)
        val autoWordSync = runCatching { AppSettings.getInstance(io.github.cluno1.sonorus.RhythmApplication.instance).translationAutoWord.value }.getOrDefault(false)
