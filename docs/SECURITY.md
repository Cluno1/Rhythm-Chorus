...
Include the affected Sonorus version, Android version, reproduction steps, impact, and the minimum proof needed to validate the issue. Avoid accessing other users' data, denial-of-service testing, or modifying production systems.
