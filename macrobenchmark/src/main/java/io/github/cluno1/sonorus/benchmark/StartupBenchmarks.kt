 ...
 *   /sdcard/Android/data/io.github.cluno1.sonorus.macrobenchmark/
 *
 * Run:
 *   .\gradlew.bat :macrobenchmark:connectedGithubBenchmarkAndroidTest
 *       "-Pandroid.testInstrumentationRunnerArguments.class=io.github.cluno1.sonorus.benchmark.StartupBenchmarks"
 *       --no-daemon
 */
